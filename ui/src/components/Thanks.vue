<template>
  <div class="row animatedsound-container">
    <div class="heading">8. Thank you</div>
    <div>&nbsp;</div>
...
export default {
  ...
  computed: {
    ...
    turkSubmissionURL() {
      ...
      return "https://script.google.com/macros/s/AKfycbzmvLbhUbqzcaTxHNcoSbFuw6tAYZ1qPyr_JmJ_7woe_PoUSdSqMoNge5CSjWdNXAxCGg/exec";
    },
  },
  methods: {
    validateForm() {
